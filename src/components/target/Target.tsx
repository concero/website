...
const BENEFIT_CARDS_ROW_1 = [
    { title: 'No vendor-lock', description: 'Retain sovereignty and control with infrastructure that works for you', icon: <StarIcon /> },
    { title: 'Distribution-first', description: 'Scaling to new chains in under 30 minutes with no added cost', icon: <DistributionIcon /> },
    { title: 'Optimise for you and your users', description: 'Define your interoperability stack according to your demands', icon: <OptimizeIcon /> },
    { title: 'Trustless', description: 'No one party has control of your transaction', icon: <TrustIcon /> },
]

const BENEFIT_CARDS_ROW_2 = [
    { title: 'Infinitely upgradable', description: 'Integrate once and upgrade to the latest easily', icon: <InfinityIcon /> },
    { title: 'Self-Servicing', description: 'Quickly deploy your own modules to gain as much control as you need', icon: <ServicingIcon /> },
    { title: 'Permissionless', description: 'Deploy Concero to where your users live to reach them quickly', icon: <PermissionlessIcon /> },
