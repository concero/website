    ...
    return (
        <div className="depin">
            <div className="depin_description_container">
                ...
                <span className="depin_subtitle">Lightweight DePin Network for decentralised fetching and delivery of txs </span>
            </div>
            <div className="depin_content_container">
                <div className="depin_illustration_container">
                    <img src={isMobile ? "/Roadmap/DePin2.svg": "/Roadmap/DePin.svg"} alt="DePIN Network" className="depin_illustration" />
                </div>
            </div>
        </div>
    );
