...
const STEPS: readonly Step[] = [
    { step: 1, title: 'Start', description: 'Liquidity provider deposits funds and target balances are updated on child pools.' },
    {
        step: 2,
        title: 'Depositing',
    ...
    },
    {
        ...
        title: 'Tx Execution',
        description:
            'User deposits $500 into Chain A pool and $500 is released to them from Chain B pool.',
    },
    {
        step: 5,
        title: 'Tx Settlement',
