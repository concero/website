...
export const SchematicStep: FC<SchematicStepProps> = ({
	...
	const tagClasses = ['schematic_step_tag', !isHovered && !isActive ? 'schematic_step_tag_idle' : '']
		.filter(Boolean)
		.join(' ')

	const titleClasses = ['schematic_step_title', isHovered ? 'schematic_step_title_hovered' : '']
		.filter(Boolean)
		.join(' ')

	const descriptionClasses = ['schematic_step_description', isHovered ? 'schematic_step_description_hovered' : '']
		.filter(Boolean)
		.join(' ')
