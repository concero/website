...
export const SocialActions: FC<SocialActionsProps> = ({ centered = true }): ReactElement => (
	<div className="social_actions">
		<div className="social_actions_divider" />
		<div className={`social_actions_content ${centered ? 'social_actions_centered' : 'social_actions_start'}`}>
