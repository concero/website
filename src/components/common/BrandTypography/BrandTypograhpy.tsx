...
export const BrandTypograhpy: FC<BrandTypographyProps> = ({ version }): JSX.Element => {
    ...
    const description = version === 'bold' 
        ? 'For headlines' 
        : 'For body text';
    ...
    return (
        <div className="brand_typography">
            <div className="brand_typography_container">
                <span className={version === 'bold' ? 'brand_typography_bold' : 'brand_typography_regular'}>
                    Aa
                </span>
            </div>
            ...
            <Button 
                ...
                size='s' 
                rightIcon={<RightIcon/>}
                onClick={() => window.open('https://fonts.google.com/specimen/DM+Sans', '_blank', 'noopener,noreferrer')}
            >
                Open Google Fonts
            </Button>
        </div>
