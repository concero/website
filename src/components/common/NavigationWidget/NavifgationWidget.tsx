...
export const NavigationWidget: FC<NavigationWidgetProps> = ({ title, link }): JSX.Element => {
	return (
		<a href={link} target="_blank" rel="noopener noreferrer" className="navigation_widget_link">
