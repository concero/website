...
export const Build: FC = (): JSX.Element => {
    ...
    const buildData = [
        ...
        {
            title: 'Ecosystem',
            subtitle: 'Get access to our Ecosystem Portal to Test, Launch and Scale your project with Concero',
        },
        {
            title: 'Apps',
            subtitle:
                'Allow any user in Web 3.0 to interact with your app no matter the chain in a single click with Concero',
        },
    ]
    ...
    return (
        <section className="build">
            ...
            <div className="build_action">
                <Button size={buttonSize} variant="primary" onClick={handleStartBuilding}>
                    Start building
                </Button>
            </div>
        </section>
