...
export const HowItWorks: FC = memo((): ReactElement => {
    ...
    const { View, play, stop, goToAndStop, getDuration, animationLoaded } = useLottie(lottieOptions, lottieStyle)
    ...
    }, [isStatic, stop, getDuration, goToAndStop])
        ...
        <section className="how_it_works">
            <div className="how_it_works_description">
                ...
                <p className="how_it_works_subtitle">
                    Concero organises interactions between specialised actors to enable interoperability for those who
                    bring value and users on-chain
                </p>
            </div>
            <div className="how_it_works_visual" onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
                {View}
            </div>
            <div className="how_it_works_action">
                <Button size="xl" variant="secondary" className="how_it_works_action_button" onClick={onClick}>
